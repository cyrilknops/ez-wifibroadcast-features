...
#ifdef TOTAL_DIST
    draw_total_distance((int)td->speed, TOTAL_DIST_POS_X, TOTAL_DIST_POS_Y, TOTAL_DIST_SCALE * GLOBAL_SCALE);
#endif
...
void draw_total_distance(int gpsspeed, float pos_x, float pos_y, float scale){
